...
$dogDiet = new DogDiet("Alimentazione", "./img/dogs/crocchette_salmone.webp", "Crocchette con Salmone", "9.39", "Lorem ipsum dolor sit amet consectetur, adipisicing elit.", "dog", "23/05/2023");
$dogAccessory = new Product("Cucce", "./img/dogs/casetta_legno.jpg", "Casetta in Legno", "249.99", "Lorem ipsum dolor sit amet consectetur, adipisicing elit.", "cat");
$dogAccessory1 = new Product("Cucce", "./img/dogs/casetta_plastica.webp", "Nicchia per Cane KENNY", "43.99", "Lorem ipsum dolor sit amet consectetur, adipisicing elit.", "cat");
...
$catDiet = new CatDiet("Alimentazione", "./img/cats/cibo_secco.webp", "Cibo Secco con Pesce", "20.99", "Lorem ipsum dolor sit amet consectetur, adipisicing elit.", "cat", "10/12/2023");
$catAccessory = new CatDiet("Alimentazione", "./img/cats/fontana_acqua.webp", "Fontana d'acqua per gatti", "19.99", "Lorem ipsum dolor sit amet consectetur, adipisicing elit.", "cat", "21/07/2024");
...
$catLitter = new Product("Lettiera", "./img/cats/lettiera_silicio.webp", "Lettiera Silicio per gatti", "5.29", "Lorem ipsum dolor sit amet consectetur, adipisicing elit.", "cat");
